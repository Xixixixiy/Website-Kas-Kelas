 ...
 * BENDAHARA DASHBOARD
 * ========================================
 * Halaman dashboard bendahara yang menampilkan
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small">Kelola keuangan kelas secara transparan</p>
            </div>
                ...
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body">
                        ...
                        <p class="mt-2 small text-muted mb-0">
                            ...
                            <strong><?php echo $total_murid; ?></strong> murid telah membayar tahun ini.
                        </p>
                    </div>
                </div>
            </div>
