 ...
 * ========================================
 * Halaman dashboard ketua kelas (mode pantau)
 * Menampilkan ringkasan saldo, partisipasi murid, dan grafik kas
 */
...
<head>
    ...
    <title>Dashboard Ketua Kelas - Kas Kelas</title>
...
<body class="bg-light">
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold mb-0">Dashboard Ketua Kelas</h4>
                <p class="text-muted small">Mode Pantau: Lihat transparansi keuangan kelas</p>
            </div>
